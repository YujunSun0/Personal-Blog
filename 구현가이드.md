...
CREATE TABLE posts (
  ...
  type TEXT NOT NULL CHECK (type IN ('TECH', 'TROUBLESHOOTING', 'LIFE')),
  thumbnail_url TEXT,
...
2. 인증 관련 컴포넌트 생성
   ...
   - `components/admin/LoginForm.tsx` - Email 로그인 폼 컴포넌트
   - `components/admin/SocialLoginButtons.tsx` - 소셜 로그인 버튼 컴포넌트
3. 인증 Hook 생성
...
- [x] Email 로그인 폼 구현 완료 (`components/admin/LoginForm.tsx`)
- [x] 소셜 로그인 버튼 구현 완료 (`components/admin/SocialLoginButtons.tsx`)
...
**체크리스트:**
- [ ] Markdown 라이브러리 설치 완료
- [ ] MarkdownRenderer 컴포넌트 구현 완료
- [ ] 코드 하이라이팅 라이브러리 설치 완료
- [ ] CodeBlock 컴포넌트 구현 완료
- [ ] Markdown 스타일 적용 완료
- [ ] PostContent 컴포넌트에 Markdown 적용 완료
...
- [ ] TagBadge 컴포넌트 구현 완료
- [ ] TagList 컴포넌트 구현 완료
- [ ] 글 작성 시 태그 연결 기능 구현 완료
- [ ] 글 상세 페이지에 태그 표시 완료
- [ ] 태그 목록 조회 시 실시간 COUNT 구현 완료
...
- [ ] 이미지 업로드 API 구현 완료
- [ ] 글 작성 시 이미지 첨부 기능 구현 완료
- [ ] 글 상세 페이지에서 이미지 표시 완료
- [ ] 이미지 최적화 적용 완료
...
**체크리스트:**
- [ ] 댓글 데이터베이스 함수 구현 완료
- [ ] CommentList 컴포넌트 구현 완료
- [ ] CommentForm 컴포넌트 구현 완료
- [ ] NonMemberCommentForm 컴포넌트 구현 완료
- [ ] 댓글 작성 기능 구현 완료 (회원/비회원)
- [ ] 댓글 수정/삭제 기능 구현 완료
- [ ] 글 상세 페이지에 댓글 통합 완료
...
| 단계 | 예상 소요 시간 | 누적 시간 |
|------|---------------|----------|
| STEP 1 | 16-21시간 | 16-21시간 |
| STEP 2 | 12-15시간 | 27-35시간 |
| STEP 3 | 22-29시간 | 49-64시간 |
| STEP 4 | 17-22시간 | 57-74시간 |
