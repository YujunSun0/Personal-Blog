...
- [ ] 썸네일 직접 업로드 기능 구현 (추후 구현 예정)
- [ ] 글 내 첫 번째 이미지 자동 추출 로직 구현 (추후 구현 예정)
- [x] 글 목록에 썸네일 표시 완료 (`components/post/PostCard.tsx`)
...
- ⏳ 글 작성 시 이미지 첨부 기능 (추후 구현 예정)
- ⏳ 썸네일 직접 업로드 기능 (추후 구현 예정)
- ⏳ 댓글 시스템 동작 확인 (회원/비회원) (미구현)
